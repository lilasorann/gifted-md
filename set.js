...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~XW2R3rTJGiURSNMw5WE2", // Add sess Id here especially when deploying on panels else use app.json and .env file...
SUDO_NUMBERS: process.env.SUDO_NUMBERS || "2347050510935,‪2347084458835‬,2349133292806‬", //Add multiple Numbers with Country Codes without (+) Separated by Comma...
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "2348139442082", // Only 1 owner Number Here, others Add to sudo numbers...
OWNER_NAME: process.env.OWNER_NAME || "VICTOR", // Input Yours custom...(Maintain font for Flow)
PACK_AUTHOR: process.env.PACK_AUTHOR || "VICTOR", // Added // Input Yours custom...
